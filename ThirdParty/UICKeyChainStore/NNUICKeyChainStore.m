...
NSString * const NNUICKeyChainStoreErrorDomain = @"com.kishikawakatsumi.uickeychainstore";
static NSString *_defaultService;

@interface NNUICKeyChainStore ()

@end

@implementation NNUICKeyChainStore
...
+ (NNUICKeyChainStore *)keyChainStoreWithService:(NSString *)service
{
    return [[self alloc] initWithService:service accessGroup:nil];
}

+ (NNUICKeyChainStore *)keyChainStoreWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
...
{
    return [[self alloc] initWithServer:server protocolType:protocolType authenticationType:NNUICKeyChainStoreAuthenticationTypeDefault];
}
...
{
    return [self initWithServer:server protocolType:protocolType authenticationType:NNUICKeyChainStoreAuthenticationTypeDefault];
}
...
- (void)commonInit
{
    _accessibility = NNUICKeyChainStoreAccessibilityAfterFirstUnlock;
}
...
+ (NSString *)stringForKey:(NSString *)key service:(NSString *)service accessGroup:(NSString *)accessGroup error:(NSError *__autoreleasing *)error
{
    ...
    NNUICKeyChainStore *keychain = [NNUICKeyChainStore keyChainStoreWithService:service accessGroup:accessGroup];
...
- (NSArray *)allKeys
{
    NSArray *items = [self.class prettify:[self itemClassObjectFromEnum: _itemClass] items:[self items]];
...
+ (NSArray *)allKeysWithItemClass:(NNUICKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = [self itemClassObjectFromEnum: itemClass];
...
+ (NSArray *)allItemsWithItemClass:(NNUICKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = [self itemClassObjectFromEnum: itemClass];
...
- (NSArray *)allItems
{
    return [self.class prettify:[self itemClassObjectFromEnum: _itemClass] items:[self items]];
}
...
- (NSMutableDictionary *)query
{
    ...
    CFTypeRef itemClass = [self itemClassObjectFromEnum: self.itemClass];
...
#endif
    } else if(itemClass == kSecClassKey) {
...
- (NSMutableDictionary *)attributesWithKey:(NSString *)key value:(NSData *)value error:(NSError *__autoreleasing *)error
{
    ...
    if (_authenticationPolicy && accessibilityObject) {
        ...
        if (floor(NSFoundationVersionNumber) <= floor(iOS_7_1_or_10_9_2) && _accessibility == NNUICKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly) {
#if TARGET_OS_IPHONE
...
- (CFTypeRef)itemClassObjectFromEnum:(NNUICKeyChainStoreItemClass)class {
    return [[self class] itemClassObjectFromEnum: class];
}

+ (CFTypeRef)itemClassObjectFromEnum:(NNUICKeyChainStoreItemClass)class {
    CFTypeRef itemClass = nil;
    switch(class) {
        ...
        case UICKeyChainStoreItemClassCryptoKey: {
...
- (CFTypeRef)protocolTypeObject
{
    switch (_protocolType) {
        case NNUICKeyChainStoreProtocolTypeFTP:
            return kSecAttrProtocolFTP;
        case NNUICKeyChainStoreProtocolTypeFTPAccount:
            return kSecAttrProtocolFTPAccount;
        case NNUICKeyChainStoreProtocolTypeHTTP:
            return kSecAttrProtocolHTTP;
        case NNUICKeyChainStoreProtocolTypeIRC:
            return kSecAttrProtocolIRC;
        case NNUICKeyChainStoreProtocolTypeNNTP:
            return kSecAttrProtocolNNTP;
        case NNUICKeyChainStoreProtocolTypePOP3:
            return kSecAttrProtocolPOP3;
        case NNUICKeyChainStoreProtocolTypeSMTP:
            return kSecAttrProtocolSMTP;
        case NNUICKeyChainStoreProtocolTypeSOCKS:
            return kSecAttrProtocolSOCKS;
        case NNUICKeyChainStoreProtocolTypeIMAP:
            return kSecAttrProtocolIMAP;
        case NNUICKeyChainStoreProtocolTypeLDAP:
            return kSecAttrProtocolLDAP;
        case NNUICKeyChainStoreProtocolTypeAppleTalk:
            return kSecAttrProtocolAppleTalk;
        case NNUICKeyChainStoreProtocolTypeAFP:
            return kSecAttrProtocolAFP;
        case NNUICKeyChainStoreProtocolTypeTelnet:
            return kSecAttrProtocolTelnet;
        case NNUICKeyChainStoreProtocolTypeSSH:
            return kSecAttrProtocolSSH;
        case NNUICKeyChainStoreProtocolTypeFTPS:
            return kSecAttrProtocolFTPS;
        case NNUICKeyChainStoreProtocolTypeHTTPS:
            return kSecAttrProtocolHTTPS;
        case NNUICKeyChainStoreProtocolTypeHTTPProxy:
            return kSecAttrProtocolHTTPProxy;
        case NNUICKeyChainStoreProtocolTypeHTTPSProxy:
            return kSecAttrProtocolHTTPSProxy;
        case NNUICKeyChainStoreProtocolTypeFTPProxy:
            return kSecAttrProtocolFTPProxy;
        case NNUICKeyChainStoreProtocolTypeSMB:
            return kSecAttrProtocolSMB;
        case NNUICKeyChainStoreProtocolTypeRTSP:
            return kSecAttrProtocolRTSP;
        case NNUICKeyChainStoreProtocolTypeRTSPProxy:
            return kSecAttrProtocolRTSPProxy;
        case NNUICKeyChainStoreProtocolTypeDAAP:
            return kSecAttrProtocolDAAP;
        case NNUICKeyChainStoreProtocolTypeEPPC:
            return kSecAttrProtocolEPPC;
        case NNUICKeyChainStoreProtocolTypeNNTPS:
            return kSecAttrProtocolNNTPS;
        case NNUICKeyChainStoreProtocolTypeLDAPS:
            return kSecAttrProtocolLDAPS;
        case NNUICKeyChainStoreProtocolTypeTelnetS:
            return kSecAttrProtocolTelnetS;
        case NNUICKeyChainStoreProtocolTypeIRCS:
            return kSecAttrProtocolIRCS;
        case NNUICKeyChainStoreProtocolTypePOP3S:
...
- (CFTypeRef)authenticationTypeObject
{
    switch (_authenticationType) {
        case NNUICKeyChainStoreAuthenticationTypeNTLM:
            return kSecAttrAuthenticationTypeNTLM;
        case NNUICKeyChainStoreAuthenticationTypeMSN:
            return kSecAttrAuthenticationTypeMSN;
        case NNUICKeyChainStoreAuthenticationTypeDPA:
            return kSecAttrAuthenticationTypeDPA;
        case NNUICKeyChainStoreAuthenticationTypeRPA:
            return kSecAttrAuthenticationTypeRPA;
        case NNUICKeyChainStoreAuthenticationTypeHTTPBasic:
            return kSecAttrAuthenticationTypeHTTPBasic;
        case NNUICKeyChainStoreAuthenticationTypeHTTPDigest:
            return kSecAttrAuthenticationTypeHTTPDigest;
        case NNUICKeyChainStoreAuthenticationTypeHTMLForm:
            return kSecAttrAuthenticationTypeHTMLForm;
        case NNUICKeyChainStoreAuthenticationTypeDefault:
...
- (CFTypeRef)accessibilityObject
{
    switch (_accessibility) {
        case NNUICKeyChainStoreAccessibilityWhenUnlocked:
            return kSecAttrAccessibleWhenUnlocked;
        case NNUICKeyChainStoreAccessibilityAfterFirstUnlock:
            return kSecAttrAccessibleAfterFirstUnlock;
        case NNUICKeyChainStoreAccessibilityAlways:
            return kSecAttrAccessibleAlways;
        case NNUICKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly:
            return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
        case NNUICKeyChainStoreAccessibilityWhenUnlockedThisDeviceOnly:
            return kSecAttrAccessibleWhenUnlockedThisDeviceOnly;
        case NNUICKeyChainStoreAccessibilityAfterFirstUnlockThisDeviceOnly:
            return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
        case NNUICKeyChainStoreAccessibilityAlwaysThisDeviceOnly:
...
{
    NSError *error = [NSError errorWithDomain:NNUICKeyChainStoreErrorDomain code:UICKeyChainStoreErrorInvalidArguments userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:NNUICKeyChainStoreErrorDomain code:-67594 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
...
#endif
    NSError *error = [NSError errorWithDomain:NNUICKeyChainStoreErrorDomain code:status userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:NNUICKeyChainStoreErrorDomain code:-99999 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
